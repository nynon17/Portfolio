  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          <span className="accent-text-gradient">{DISPLAY_NAME}</span>
        </motion.h1>
        ...
        >
          ...
          >
            ...
            <span className="text-muted-foreground">{DISCORD_HANDLE}</span>
          </a>
          ...
          {GITHUB_USERNAME && GITHUB_USERNAME !== "YOUR_USERNAME" && (
            ...
            >
              ...
              <span className="text-muted-foreground">@{GITHUB_USERNAME}</span>
            </a>
          )}
        </motion.div>
