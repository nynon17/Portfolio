      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="flex flex-col gap-4">
          {links.map((link, i) => (
            ...
            >
              <div className="glass-card group flex items-center gap-4 p-4 hover:glow-border-strong transition-all duration-300">
                <a
                  href={link.href}
                  target="_blank"
                  rel="noreferrer"
                ...
                >
                  <div className="w-10 h-10 rounded-xl accent-gradient flex items-center justify-center text-primary-foreground shrink-0 group-hover:scale-110 transition-transform duration-300">
                    {link.icon}
                  </div>
                ...
                {link.copyValue && (
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      copyToClipboard(link.copyValue!, link.copyLabel!);
                    }}
